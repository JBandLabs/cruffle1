        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {FLAVORS.map((flavor) => (
            ...
            >
              ...
              <button className="mt-auto w-full text-bubblegum font-bold border-2 border-bubblegum px-6 py-2 rounded-full hover:bg-bubblegum hover:text-white transition-all bouncy-hover">
                Add to Box
              </button>
            </div>
          ))}
